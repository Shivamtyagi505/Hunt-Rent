                  ...
                  Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          'WELCOME',
                          style: TextStyle(fontSize: 30, fontWeight: FontWeight.w300, color: Color(0xFF460C54)),
                        ),
                      ),
                      Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => SignUpVendor()));
                            },
                          )),
                      Container(
                        child: Text(
                      ...
                      Container(
                          ...
                          child: RaisedButton(
                            ...
                            child: Text(
                              'Log In',
                              style: TextStyle(fontSize: 30, color: Color(0xFF460C54)),
                            ),
                            onPressed: () {
